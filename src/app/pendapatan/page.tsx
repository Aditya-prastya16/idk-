              ...
              <table className="min-w-full bg-white">
                <thead className="bg-blue-600 text-white">
                  <tr>
                    ...
                    <th className="text-left p-3 md:p-4 font-semibold text-sm md:text-base">Asal</th>
                    <th className="text-left p-3 md:p-4 font-semibold text-sm md:text-base">Nominal</th>
                    <th className="text-left p-3 md:p-4 font-semibold text-sm md:text-base">Tanggal</th>
